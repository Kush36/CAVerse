// src/pages/IntermediateLevel.js
...
export default function IntermediateLevel() {
  ...
  const [selectedPlan, setSelectedPlan] = useState("pass-guarantee");
  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Personal Prediction List for 2025",
    ...
    // Normal Plans
    {
      id: "normal-chapterwise",
      name: "UNIT WISE",
      price: 5999,
      original: 9999,
      features: [
        "Individual 5 Chapter - 1Test ",
      ...
      <section className="py-20 text-center bg-gradient-to-t from-purple-900/20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-green-400 to-emerald-600 bg-clip-text text-transparent">
            Ready to Start Your CA Intermediate Journey?
          </h2>
