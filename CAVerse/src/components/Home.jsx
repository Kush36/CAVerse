  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
        <Link
          to="/signup"
          className="group relative px-8 py-4 rounded-full font-bold text-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-2xl hover:shadow-indigo-500/50 transform hover:scale-105 transition-all overflow-hidden"
        >
